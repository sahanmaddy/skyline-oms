...
export default function TypeCreate() {
    ...
    return (
        <AuthenticatedLayout header={<ModuleStickyTitle module="Inventory" section="New attribute type" />}>
            <Head title="New attribute type · Inventory" />
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm dark:border-cursor-border dark:bg-cursor-surface">
                        <form
                            onSubmit={(e) => {
                                e.preventDefault();
                                form.post(route('inventory.attribute-types.store'), {
                                    preserveScroll: true,
                                    onError: () => {
                                        scrollToFirstError();
