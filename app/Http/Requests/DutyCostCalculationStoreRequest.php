...
class DutyCostCalculationStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cid_basis' => ['nullable', Rule::in(['weight', 'uom'])],
            'eid_rate_per_kg_lkr' => ['nullable', 'numeric', 'min:0'],
            'eid_basis' => ['nullable', Rule::in(['weight', 'uom'])],
            'statistical_value_basis' => ['nullable', Rule::in(['weight', 'uom'])],
